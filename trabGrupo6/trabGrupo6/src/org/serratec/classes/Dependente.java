...
public final class Dependente extends Pessoa {
	...
	public Dependente(String nome, String cpf, LocalDate dataNascimento, Parentesco parentesco)
		...
		if (idade >= 18) {
			...
			throw new DependenteException(
					"Erro 202: Só é permitido cadastrar dependentes abaixo de 18 anos. O(A) dependente " + nome
							+ " (CPF: " + cpf + ") não foi cadastrado(a).");
		}

		if (dataNascimento.isAfter(LocalDate.now())) {
			throw new DependenteException("Erro 204: Data de nascimento inválida. O(A) dependente " + nome + " (CPF: "
					+ cpf + ") não foi cadastrado(a).");
		}
	...
	public String toString() {
		return "Dependente: " + nome + ", CPF: " + cpf + ", Data de nascimento: " + dataNascimento + ", Parentesco: "
				+ parentesco;
	}
